...
# --- 1. 앱의 기본 설정 ---
st.set_page_config(page_title="실험실 재고 관리기 v19", layout="wide")
st.title("🔬 실험실 재고 관리기 v19")
...
with tab3:
    ...
    if df_db.empty:
        ...
        # (v19 수정: Styler.bar는 100을 초과해도 괜찮으므로 clip(0, 100) 제거)
        ...
        # ▼▼▼ [수정됨] v19: v17의 style.bar(cmap='RdYlGn') (컬러 막대) 복구 ▼▼▼
