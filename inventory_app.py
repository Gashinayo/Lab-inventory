...
# --- 1. 앱의 기본 설정 ---
st.set_page_config(page_title="실험실 재고 관리기 v39", layout="wide")
st.title("🔬 실험실 재고 관리기 v39")
...
with tab3:
    ...
    if df_db.empty:
        ...
        # (v38/v27 방식: data_editor + column_config)
        st.data_editor( 
