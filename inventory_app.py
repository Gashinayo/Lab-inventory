...
# --- 1. 앱의 기본 설정 ---
st.set_page_config(page_title="실험실 재고 관리기 v21", layout="wide")
st.title("🔬 실험실 재고 관리기 v21")
...
with tab3:
    ...
    if df_db.empty:
        ...
        # ▼▼▼ [수정됨] v21: v19(v17)의 style.bar(cmap='RdYlGn') (컬러 막대) 복구 ▼▼▼
