...
# --- 1. 앱의 기본 설정 ---
st.set_page_config(page_title="실험실 재고 관리기 v23", layout="wide")
st.title("🔬 실험실 재고 관리기 v23")
...
with tab3:
    ...
    if df_db.empty:
        ...
        # ▼▼▼ [수정됨] v23: v19/v17의 style.bar(cmap='RdYlGn') (컬러 막대) 복구 ▼▼▼
