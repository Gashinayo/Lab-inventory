...
# --- 1. 앱의 기본 설정 ---
st.set_page_config(page_title="실험실 재고 관리기 v27", layout="wide")
st.title("🔬 실험실 재고 관리기 v27")
