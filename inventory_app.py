...
# --- 1. 앱의 기본 설정 ---
st.set_page_config(page_title="실험실 재고 관리기 v28", layout="wide")
st.title("🔬 실험실 재고 관리기 v28")
...
with tab3:
    ...
    if df_db.empty:
        ...
        # (ProgressColumn은 0~100 사이의 숫자만 받음)
        ...
        display_columns = [
            ...
            "재고 비율 (%)", # (v27의 "재고 비율 (Bar)", "재고 %" 대신 원본 컬럼 사용)
