...
# --- 1. 앱의 기본 설정 ---
st.set_page_config(page_title="실험실 재고 관리기 v22", layout="wide")
st.title("🔬 실험실 재고 관리기 v22")
...
with tab3:
    ...
    if df_db.empty:
        ...
        # ▼▼▼ [수정됨] v22: st.data_editor + BarChartColumn + 빨간색 텍스트(applymap) ▼▼▼
        ...
        st.data_editor(
            ...
            # (BarChartColumn 사용: matplotlib 불필요, 안정적)
            column_config={
                "재고 비율 (%)": st.column_config.BarChartColumn(
                    "재고 비율 (%)",
