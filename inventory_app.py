...
# --- 1. 앱의 기본 설정 ---
st.set_page_config(page_title="실험실 재고 관리기 v26", layout="wide")
st.title("🔬 실험실 재고 관리기 v26")
...
with tab3:
    ...
    if df_db.empty:
        ...
        st.data_editor( # (v20 방식: st.data_editor)
