...
# --- 1. 앱의 기본 설정 ---
st.set_page_config(page_title="실험실 재고 관리기 v17", layout="wide")
st.title("🔬 실험실 재고 관리기 v17")
...
with tab3:
    ...
    if df_db.empty:
        ...
        # ▼▼▼ [수정됨] v17: v14의 style.bar(cmap='RdYlGn') (컬러 막대) 복구 ▼▼▼
