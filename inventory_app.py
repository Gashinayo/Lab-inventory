...
# --- 1. 앱의 기본 설정 ---
st.set_page_config(page_title="실험실 재고 관리기 v16", layout="wide")
st.title("🔬 실험실 재고 관리기 v16")
...
with tab3:
    ...
    if df_db.empty:
        ...
        # ▼▼▼ [수정됨] v16: v12 방식(applymap) + v10 방식(ProgressColumn) 조합 ▼▼▼
